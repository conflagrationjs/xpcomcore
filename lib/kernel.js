...
function Kernel(mixinScope) {
  ...
  if (mixinScope) {
    ...
    var callingGetters = {'$CURRENT_FILE': {defaultArgs: [2]}, '$CURRENT_DIRECTORY': {defaultArgs: [3] }, '$ARGV': {}};
...
Kernel.prototype = {
  ...
  /**
    ...
    */
  $ARGV: function() {
    return $Cc["@conflagrationjs.org/xpcomcore/generic-command-line-handler-clh;1"].getService().wrappedJSObject.args;
  },
